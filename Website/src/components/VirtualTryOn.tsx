          ...
          {/* Left side - Person Image */}
              <div className="space-y-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h2 className="text-xl font-semibold text-slate-200">Your Photo</h2>
                    <p className="text-slate-400 text-sm">Please upload a photo of yourself standing straight</p>
                  </div>
                </div>
                ...
                <div 
                  ...
                  } transition-colors rounded-xl p-4 group`}
              ...
              {personImage ? (
                  ...
                  <img 
                    ...
                    <div className="text-center">
                      ...
                      <div className="mt-6 flex justify-center gap-4">
                        <button
                          onClick={takePhoto}
                          className="px-6 py-3 bg-slate-700 hover:bg-slate-600 rounded-lg transition-all flex items-center gap-2 hover:scale-105"
                        >
                          <Camera size={20} />
                          Take Photo
                        </button>
                  <button 
                          onClick={stopCamera}
                          className="px-6 py-3 bg-red-900/20 text-red-200 rounded-lg hover:bg-red-900/30 transition-all flex items-center gap-2"
                  >
                          <X size={20} />
                          Cancel
                  </button>
                  ...
                  >
                    ...
                    Upload Photo
                          ...
                          <button
                            onClick={startCamera}
                            className="inline-flex items-center gap-2 px-6 py-3 bg-slate-700 hover:bg-slate-600 rounded-lg transition-all hover:scale-105"
                          >
                            <Camera size={20} />
                            Take a Photo
                          </button>
          ...
          {/* Right side - Garment Upload */}
              <div className="space-y-6">
                <div className="flex items-center gap-3">
                  <div className="h-8 w-1 bg-slate-600 rounded-full" />
                  <div>
                    <h2 className="text-xl font-semibold text-slate-200">Upload Garment</h2>
                    <p className="text-slate-400 text-sm">Upload the garment image you want to try on</p>
                  </div>
                </div>
          ...
          <button
            ...
            disabled={!personImage || !garmentImage || isLoading}
              ...
              isLoading 
                    ...
                    : 'bg-gradient-to-r from-slate-700 to-slate-600 hover:from-slate-600 hover:to-slate-500 hover:scale-105'
                }`}
              >
        ...
        {result && (
              <div className="mt-12 animate-fade-in">
                <div className="flex items-center gap-3 mb-6">
                  <div className="h-8 w-1 bg-gradient-to-b from-slate-500 to-slate-600 rounded-full" />
                  <h2 className="text-xl font-semibold text-slate-200">Generated Result</h2>
                </div>
                <div className="backdrop-blur-xl bg-slate-800/20 rounded-xl border border-slate-700/50 p-6 shadow-2xl">
                ...
                >
                  ...
                  Download Result
                    ...
                    <div className="relative">
                      ...
                      {showShareMenu && (
                        <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-48 bg-slate-800 rounded-lg shadow-xl border border-slate-700 p-2 animate-fade-in">
                          <div className="relative">
                            <button
                              onClick={() => copyToClipboard(result)}
                              className="w-full px-4 py-2 flex items-center gap-2 hover:bg-slate-700/50 rounded transition-colors text-left"
                            >
