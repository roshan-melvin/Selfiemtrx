...
const API_KEY = "AIzaSyAocS1FFOME02GvM3Ctv0Y9TI45wknW7oc";
...
// Function for BMI analysis using gemini-2.0-flash
export async function getBMIAnalysis(prompt: string): Promise<string> {
  try {
...
// Function for image analysis using gemini-1.5-flash
