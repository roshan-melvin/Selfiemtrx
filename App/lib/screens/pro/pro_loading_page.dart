...
class ProLoadingPage extends StatefulWidget {
  ...
  @override
  State<ProLoadingPage> createState() => _ProLoadingPageState();
}

class _ProLoadingPageState extends State<ProLoadingPage> with SingleTickerProviderStateMixin {
        ...
        switch (status) {
          case ProcessingStatus.completed:
            ...
            Navigator.of(context).pushReplacement(
              MaterialPageRoute(
                builder: (context) => widget.apiService is GeminiApiProService
                    ? ProResultsScreen(response: results)
      ...
      child: Row(
        children: [
          Icon(
            icon,
            size: 24,
            color: isActive ? bottomPanelBlue : Colors.grey[600],
          ),
          SizedBox(width: 16),
          Text(
            text,
