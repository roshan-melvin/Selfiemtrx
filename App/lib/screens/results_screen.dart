...
class _ResultsScreenState extends State<ResultsScreen> {
  ...
  Future<void> _handleDownload() async {
    try {
      ...
      // Get storage directory for Downloads
      ...
      final fileName = 'analysis_results_$timestamp.jpg';
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildInfoRow(
                        'Reference Based Height', 
                        '${widget.results['height_reference_based']?.toStringAsFixed(2) ?? 'N/A'} cm'
                      ),
